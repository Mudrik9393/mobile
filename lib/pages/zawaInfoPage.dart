...
import '../pages/dashboard.dart'; // hakikisha huu upo

class ZawaInfoPage extends StatefulWidget {
  const ZawaInfoPage({super.key});

  @override
  State<ZawaInfoPage> createState() => _ZawaInfoPageState();
}
                    ...
                    Positioned(
                      ...
                      child: Column(
                        children: [
                          ...
                          GestureDetector(
                            onTapDown: (_) => setState(() => ungujaScale = 1.1),
                            onTapUp: (_) => setState(() {
                              ungujaScale = 1.0;
                              selectedIsland = 'Unguja';
                              selectedRegion = null;
                            }),
                            onTapCancel: () => setState(() => ungujaScale = 1.0),
                            child: AnimatedScale(
                              scale: ungujaScale,
                    ...
                    Positioned(
                      ...
                      child: Column(
                        children: [
                          ...
                          GestureDetector(
                            onTapDown: (_) => setState(() => pembaScale = 1.1),
                            onTapUp: (_) => setState(() {
                              pembaScale = 1.0;
                              selectedIsland = 'Pemba';
                              selectedRegion = null;
                            }),
                            onTapCancel: () => setState(() => pembaScale = 1.0),
                            child: AnimatedScale(
                              scale: pembaScale,
                              duration: const Duration(milliseconds: 200),
